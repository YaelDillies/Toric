...
\begin{theorem}
  \label{thm:1.1.17}
  \uses{1-1-3-aff-tor-var, 1-1-7-YA, 1-1-10-lattice-ideal, affSemi}
  TFAE:
  \begin{enumerate}
...
\end{theorem}
\begin{proof}
  \uses{torActOnAlg, 1-1-8-YA-aff-tor-var, 1-1-9-ideal-YA, prop:1.1.14, lmm:1.1.16}
  % \leanok
