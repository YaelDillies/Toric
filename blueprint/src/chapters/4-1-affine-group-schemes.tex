...
\begin{proposition}[Spec as a functor on algebras is fully faithful]
  ...
  \uses{0-spec-alg}
  \lean{preservesLimitsOfSize_algSpec, algSpec.instFull, algSpec.instFaithful, algSpec.fullyFaithful}
  \leanok
...
\begin{proposition}[Spec sends cocommutative bialgebras to commutative monoid schemes]
  ...
  \uses{0-spec-hopf}
  \lean{AlgebraicGeometry.Scheme.asOver.instIsCommMonObj, AlgebraicGeometry.Scheme.asOver.instCommGrpObj}
  \leanok
