...
\begin{proposition}[Spec maps cocommutative Hopf algebras to commutative group schemes]
  \label{0-cocomm-hopf-spec-comm}
  \uses{0-spec-hopf}
  % \lean{}
  % \leanok
...
\begin{lemma}
  \label{0-spec-grp-alg-hom}
  \uses{0-spec-grp-alg}
  % \lean{}
  % \leanok

  The functor $G \rightsquigarrow \Spec R[G]$ from the category of groups to the category of group schemes over $\Spec R$ is a group homomorphism on hom sets.
\end{lemma}
\begin{proof}
  \uses{}
  % \leanok
