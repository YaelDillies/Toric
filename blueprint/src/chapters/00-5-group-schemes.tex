...
\begin{definition}[The split torus]
  \label{0-torus}
  \lean{AlgebraicGeometry.Scheme.torus, AlgebraicGeometry.Scheme.torus.instCanonicallyOver}
  \leanok
...
\begin{lemma}[The split torus over $\Spec R$]
  \label{0-torus-spec}
  \uses{0-torus}
  \lean{AlgebraicGeometry.Scheme.torusIsoSpec, AlgebraicGeometry.Scheme.torusIsoSpecOver}
  \leanok
