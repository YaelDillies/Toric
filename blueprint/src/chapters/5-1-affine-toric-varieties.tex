...
\begin{definition}
  ...
  Define $\Phi'_\MCA : D_S(G) \to \G_m^s$ as the image under $D_S$ of the map
  \begin{align*}
    \Z^{\oplus s} & \to G \\
    e_i & \mapsto \MCA_i.
  \end{align*}
...
\begin{definition}
  ...
  Let $S$ be a scheme. Let $G$ be an abelian group.
  Let $s$ be an arbitrary indexing type, and $\MCA : s \to G$ an indexed family.
  Define $\Phi_\MCA : D_S(G) \to \mathbb A^s$
  as the image under $D_S$ of the map
  \begin{align*}
    \N^{\oplus s} & \to G \\
    e_i & \mapsto \MCA_i.
  \end{align*}
...
\begin{definition}
  ...
  Let $S$ be a scheme. Let $G$ be an abelian group.
  Let $s$ be an arbitrary indexing type, and $\MCA : s \to G$ an indexed family.
  Define $Y_\MCA$ is the scheme-theoretic closure of $\im \Phi_\MCA$ in $\mathbb A^s$.
\end{definition}
