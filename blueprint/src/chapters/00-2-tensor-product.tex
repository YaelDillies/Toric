...
\begin{proof}
  ...
  (repeatedly using TensorProduct.map_injective_of_flat_flat).
% \href{https://leanprover-community.github.io/mathlib4_docs/find/?pattern=TensorProduct.map_injective_of_flat_flat#doc}{\tt{TensorProduct.map\_injective\_of\_flat\_flat}}
  The map
