...
\input{chapters/00-1-affine-monoids.tex}
\input{chapters/00-2-tensor-product.tex}
\input{chapters/00-3-hopf-algebras.tex}
\input{chapters/00-4-cat-theory.tex}
\input{chapters/00-5-group-schemes.tex}
\input{chapters/00-6-diag.tex}
\input{chapters/00-7-torus.tex}

\chapter{Affine Toric Varieties}

\input{chapters/01-1-introduction-affine-toric-varieties.tex}
\input{chapters/01-2-cones-and-affine-toric-varieties.tex}
