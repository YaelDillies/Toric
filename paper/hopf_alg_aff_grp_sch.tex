...
This involves finding a \emph{counit} $R[G] \to R$,
a \emph{comultiplication} $R[G] \to R[G \times G]$ and an \emph{antipode} $R[G] \to R[G]$
...
to make $R[G]$ into a \emph{$R$-Hopf algebra}, and we will in fact execute the whole step
...
how to deal with/automate routine computations in Hopf algebras
and finally how to translate between the concrete description of a Hopf algebra
in terms of linear maps and the categorical machinery of cogroup objects.
